 ...
 */
final class Version20210201201416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE outing (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, organizer_id INT NOT NULL, location_id INT NOT NULL, campus_id INT NOT NULL, outing_name VARCHAR(50) NOT NULL, start_date DATETIME NOT NULL, duration INT DEFAULT NULL, closing_date DATETIME NOT NULL, max_participants INT NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_F2A106255D83CC1 (state_id), INDEX IDX_F2A10625876C4DDA (organizer_id), INDEX IDX_F2A1062564D218E (location_id), INDEX IDX_F2A10625AF5D55E1 (campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
